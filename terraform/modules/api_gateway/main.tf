...
resource "aws_api_gateway_deployment" "deployment" {
  triggers = {
    ...
    redeployment = sha1(jsonencode([
      aws_api_gateway_resource.museumResource.id,
      aws_api_gateway_method.options.id,
      aws_api_gateway_method.putMuseumMethod.id,
      aws_api_gateway_method.getMuseumMethod.id,
      aws_api_gateway_method.postMuseumMethod.id,
      aws_api_gateway_method.deleteMuseumMethod.id,
      aws_api_gateway_integration.options_integration.id,
      aws_api_gateway_integration.put_lambda_integration.id,
      aws_api_gateway_integration.delete_lambda_integration.id,
      aws_api_gateway_integration.post_lambda_integration.id,
